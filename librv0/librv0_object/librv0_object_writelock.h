...
//create object writelock struct on stack
    librv0_object_writelock *librv0_object_writelock_create_on_stack( librv0_object_writelock *t, librv0_object *prt );
//destroy object writelock struct
    void librv0_object_writelock_destroy( librv0_object_writelock **t );
//destroy object writelock struct on stack
    void librv0_object_writelock_destroy_on_stack( librv0_object_writelock *t );
...
//set id
    void librv0_object_writelock_set_id( unsigned long long id );
//set priority
    void librv0_object_writelock_set_priority( int p_bigger_is_higher );
//execute
